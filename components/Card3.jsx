...
const Card3 = () => {
  return (
    <div className="flex items-center justify-between w-full gap-10 mt-7 text-xl">
        <div className="flex flex-col items-center gap-2 w-1/2 bg-white rounded-xl p-4 py-12 sd">
        ...
        <div className="flex flex-col items-center gap-2 w-1/2 bg-white rounded-xl px-4 py-12 sd">
